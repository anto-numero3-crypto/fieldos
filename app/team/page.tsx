      ...
      <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
        ...
        {members.length === 0 ? (
          <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-gray-200 bg-white py-20 text-center">
            ...
            <h3 className="text-base font-semibold text-gray-900 mb-1">Aucun membre d&apos;équipe</h3>
            <p className="text-sm text-gray-400 mb-6 max-w-xs">Ajoutez des techniciens, répartiteurs et administrateurs pour constituer votre équipe.</p>
