...
export const metadata: Metadata = { title: 'Careers — Gestivio', description: 'Join the Gestivio team. Open positions coming soon.' }
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center py-20 px-4 text-center">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-3">We&apos;re Hiring</h1>
        <p className="text-lg text-gray-500 max-w-md mb-4">We&apos;re a small but growing team based in Québec, Canada. Open positions will be listed here soon.</p>
        <p className="text-gray-500 mb-8">In the meantime, send your résumé to <a href="mailto:jobs@gestivio.ca" className="text-indigo-600 hover:underline">jobs@gestivio.ca</a></p>
