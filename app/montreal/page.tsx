    ...
    <>
      ...
      <MarketingShell>
        ...
        <section className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-8">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Commencez dès aujourd&apos;hui</h2>
          <div className="grid gap-3 sm:grid-cols-2">
            <Link href="/pricing" className="flex items-center gap-2 rounded-xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 hover:border-indigo-200 dark:hover:border-indigo-800 hover:bg-indigo-50/50 dark:hover:bg-indigo-950/30 transition-colors">
              <span className="text-sm font-semibold text-gray-900 dark:text-white">Voir nos plans</span>
              <ArrowRight className="h-3.5 w-3.5 text-indigo-600 dark:text-indigo-400 ml-auto" />
            </Link>
            <Link href="/signup" className="flex items-center gap-2 rounded-xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 hover:border-indigo-200 dark:hover:border-indigo-800 hover:bg-indigo-50/50 dark:hover:bg-indigo-950/30 transition-colors">
              <span className="text-sm font-semibold text-gray-900 dark:text-white">Essai gratuit 14 jours</span>
              <ArrowRight className="h-3.5 w-3.5 text-indigo-600 dark:text-indigo-400 ml-auto" />
            </Link>
          </div>
        </section>
