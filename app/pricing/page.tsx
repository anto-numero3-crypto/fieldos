  ...
  const GROUPS: Group[] = [
    ...
    },
    {
      ...
      rows: [
        ...
        { label: fr ? 'Synchronisation Google Calendar'    : 'Google Calendar sync',       demarrage: true, pro: true, croissance: true },
        { label: fr ? 'Portail de réservation public'      : 'Public booking portal',      demarrage: true, pro: true, croissance: true },
        { label: fr ? 'Catalogue de produits et services'  : 'Product & service catalog',  demarrage: true, pro: true, croissance: true },
        { label: fr ? 'Assistant IA (messages/mois)'       : 'AI Assistant (messages/mo)', demarrage: '30', pro: UNLIMITED, croissance: UNLIMITED },
      ],
    },
    {
    ...
    {
      title: fr ? 'Croissance et analyse' : 'Growth & analytics',
      rows: [
        { label: fr ? 'Rapports complets et tableaux de bord' : 'Full reports and dashboards',   demarrage: false, pro: true, croissance: true },
        { label: fr ? 'Analyses IA (insights)'                : 'AI Insights',                   demarrage: false, pro: true, croissance: true },
        { label: fr ? 'Campagnes marketing clients'           : 'Customer marketing campaigns',  demarrage: false, pro: true, croissance: true },
