        ...
        <div className="flex items-center gap-3 mb-6">
          <div className="relative flex-1 max-w-sm">
            ...
            <input
              ...
              className="block w-full rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 pl-9 pr-4 py-2.5 text-base sm:text-sm text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 shadow-sm"
            />
          </div>
        ...
        {customers.length === 0 ? (
          ...
          <div className="rounded-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm overflow-hidden">
                    ...
                    <tr key={c.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors group">
                      <td className="px-5 py-4 whitespace-nowrap">
                        <div className="flex items-center gap-3">
                          ...
                          <Link href={`/customers/${c.id}`} className="text-sm font-semibold text-gray-900 dark:text-white hover:text-indigo-600 transition-colors">{c.name}</Link>
                        </div>
                      </td>
                          ...
                          <div className="relative">
                            ...
                            {menuOpen === c.id && (
                              <>
                                ...
                                <div className="absolute right-0 top-full mt-1 z-20 w-40 rounded-xl border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-lg py-1 slide-up">
                                  <button onClick={() => deleteCustomer(c.id)} className="flex w-full items-center gap-2 px-3 py-2 text-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-950/50 transition-colors">
            ...
            <div className="sm:hidden divide-y divide-gray-100 dark:divide-gray-800">
              {paged.map((c) => (
                <Link key={c.id} href={`/customers/${c.id}`} className="block p-4 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
