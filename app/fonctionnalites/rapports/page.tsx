...
export default function RapportsPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: fr ? 'Oui. Les donnees sont mises a jour en continu. Chaque nouvelle intervention, facture ou paiement est reflété immédiatement.' : 'Yes. Data is updated continuously. Every new job, invoice, or payment is reflected immediately.',
    },
    {
