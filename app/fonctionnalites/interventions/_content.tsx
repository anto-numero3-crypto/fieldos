        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            {[
              ...
              { num: '3', title: fr ? 'Suivez l\'avancement' : 'Track progress', desc: fr ? 'Voyez le statut de chaque intervention en temps réel : en route, en cours, compl\u00e9t\u00e9e. Le client est notifi\u00e9 automatiquement à chaque étape.' : 'See each job\'s status in real-time: en route, in progress, completed. The client is automatically notified at each step.' },
            ].map((step) => (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 gap-8">
            {[
              ...
              { icon: Clock, title: fr ? 'Statuts en temps réel' : 'Real-time status', desc: fr ? 'Suivez l\'avancement de chaque intervention : planifi\u00e9e, en route, en cours, compl\u00e9t\u00e9e.' : 'Track each job\'s progress: planned, en route, in progress, completed.' },
