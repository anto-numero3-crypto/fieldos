            ...
            <div className="p-6">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <h2 id="confirm-title" className="text-base font-bold text-gray-900">{active.title}</h2>
                  {active.description && (
                    <p id="confirm-desc" className="mt-1.5 text-sm text-gray-600 leading-relaxed">{active.description}</p>
                  )}
                </div>
              </div>
              ...
              {active.prompt && (
                <div className="mt-4">
                  <label className="block text-xs font-medium text-gray-600 mb-1">{active.prompt.label}</label>
                  <textarea
                    rows={3}
                    value={promptValue}
                    onChange={(e) => setPromptValue(e.target.value)}
                    placeholder={active.prompt.placeholder}
                    className="block w-full rounded-xl border border-gray-200 bg-white px-3 py-2 text-sm text-gray-900 placeholder:text-gray-400 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 resize-none"
                  />
                </div>
              )}
            </div>
